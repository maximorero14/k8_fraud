...
ENV OTEL_SERVICE_NAME=k8_fraud
ENV OTEL_RESOURCE_ATTRIBUTES=service.name=k8_fraud,environment=dev
...
#docker rm -f k8_fraud_container && docker build -t k8_fraud . && docker run -p 8080:8080 --name k8_fraud_container k8_fraud